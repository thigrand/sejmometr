...
export class SejmometrService {
  ...
  private deputiesIndexedByPP: Subject<Array<Array<SingleDeputyDataHttpResponse>>> = new Subject<Array<Array<SingleDeputyDataHttpResponse>>>();
  private mostExpensiveDeputies: Subject<Array<any>> = new Subject<Array<any>>();
  private allDeputies: Array<SingleDeputyDataHttpResponse>;
  /**
   * @constructor
